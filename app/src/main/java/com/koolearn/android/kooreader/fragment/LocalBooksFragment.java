...
public class LocalBooksFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = "LocalBooksFragment";
...
//        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getBooks() {
        bookCollectionShadow.bindToService(getActivity(), new Runnable() {
            public void run() {
                ...
                Log.e(TAG, "bookshelf = " + bookshelf);
                // E/LocalBooksFragment: bookshelf = [Book{myPath='/storage/emulated/0/我的.epub', myCoverPath='null'}
    ...
    private RecyclerItemClickListener.OnItemClickListener onItemClickListener = new RecyclerItemClickListener.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            Log.e(TAG, "onItemClick = " + mLocalBookAdapter.getBook(position));
            // E/LocalBooksFragment: onItemClick = Book{myPath='/storage/emulated/0/我的.epub', myCoverPath='null'}
            String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/我的.epub";
//            KooReader.openBookActivity(getActivity(), mLocalBookAdapter.getBook(position), null);
            Book book = new Book(path, "null");
